      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <a
              href="#"
              className="items-center space-x-2 group mb-4 inline-block"
            >
            ...
            <p className="text-sm leading-relaxed mb-6">
              Tu casillero internacional de confianza. Conectando EE.UU. con
              Colombia y México de manera rápida, segura y transparente.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  <div>+1 (305) 555-0190</div>
                  <div>+57 601 555-0190</div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <svg
                ...
                <div className="text-sm">
                  <div>info@ncargo.com</div>
                  <div>soporte@ncargo.com</div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <svg
                ...
                <div className="text-sm">
                  <div>7950 NW 53rd St Suite 337</div>
                  <div>Miami, FL 33166 USA</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <span className="text-sm text-gray-400 mb-4 md:mb-0">
              © 2024 N-Cargo International Logistics. Todos los derechos
              reservados.
            </span>
